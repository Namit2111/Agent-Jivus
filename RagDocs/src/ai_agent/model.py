from src.ai_agent.config import PHONE_NUMBER_ID,assistant_id
...
class preData:
    def __init__(self,customer_number,sales_person_name,company_name,product_summary):
        ...
        self.first_message = get_prompt_from_file(prompt_name="first_msg_ai_agent.txt").format(sales_person_name=sales_person_name,company_name=company_name)
        self.prompt =get_prompt_from_file(prompt_name="ai_agentmain_prompt.txt").format(product_summary=product_summary,sales_person_name=sales_person_name,company_name=company_name)
        self.data = {
